        ...
        <div id="insert-container" class="container-sm">
            <div id='innercontainer'>
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" id="title-id" placeholder="Title ID" maxlength="6">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="title" class="col-sm-2 col-form-label">Title</label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" id="title" placeholder="Title" maxlength="80">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row" style="margin-bottom: 0;" id="button">
