    ...
    <div class="container-fluid page-container">
        ...
        <div class="container-fluid aside">
            ...
            <div class="container-fluid table-container">
                <?                
                    $uquery = "SELECT * FROM userinfo";
                    if (!($uresults = mySelectQuery($uquery))) {
                        echo "Selection query failed";
                    } else {
                        while ($urow = $uresults->fetch_assoc()) {
                            ...
                            $table .= "<tr>";
                            if ($role == 1) {
                                $table .= "<td class='delete-cell'><a type='button' class='btn btn-primary rounded-pill px-3 delete' id='" . $urow['user_id'] . "'>Delete</a></td>";
                                $table .= "<td class='update-cell'><a type='button' class='btn btn-primary rounded-pill px-3 update' id='" . $urow['user_id'] . "'>Update</a></td>";
                            }
                            $table .= "<td class='id-cell'>" . $urow['user_id'] . "</td>"
                                . "<td class='username-cell' id='" . $urow['user_id'] . "'>" . $urow['username'] . "</td>"
                                . "<td class='pass-cell' id='" . $urow['user_id'] . "'>" . $urow['pass'] . "</td>"
                                . "<td class='role-cell' id='" . $urow['user_id'] . "'>";
